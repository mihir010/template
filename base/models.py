...
class Employee(models.Model):
    ...
    manager = models.ForeignKey('self', on_delete=models.SET_NULL, blank=True, null=True, related_name='team_members')
    ...
    bonus_rate = models.DecimalField(max_digits=5, decimal_places=2, blank=True, null=True)
    ...
    employee_signature = models.ImageField(upload_to='employee_signatures/', blank=True, null=True)
    ...
    major_subject = models.CharField(max_length=100, blank=True, null=True)
    ...
    payroll_schedule = models.CharField(max_length=50, blank=True, null=True)
...
class Customer(models.Model):
    ...
    customer_loyalty_program = models.CharField(max_length=50, blank=True, null=True)
    customer_loyalty_points = models.PositiveIntegerField(default=0)
    customer_loyalty_tier = models.CharField(max_length=50, blank=True, null=True)
    ...
    customer_signature = models.ImageField(upload_to='customer_signatures/', blank=True, null=True)
    company_name = models.CharField(max_length=100, blank=True, null=True)
    company_website = models.URLField(blank=True, null=True)
    company_industry = models.CharField(max_length=50, blank=True, null=True)
    company_size = models.PositiveIntegerField(blank=True, null=True)
    company_revenue = models.DecimalField(max_digits=12, decimal_places=2, blank=True, null=True)
    company_employees = models.PositiveIntegerField(blank=True, null=True)
    contact_person = models.ForeignKey(Employee, on_delete=models.SET_NULL, blank=True, null=True, related_name='customer_contacts')
...
class Sale(models.Model):
    ...
    order_tax = models.DecimalField(max_digits=10, decimal_places=2, default=0)
    ...
    order_tracking_number = models.CharField(max_length=50, blank=True, null=True)
    ...
    order_billing_address_line2 = models.CharField(max_length=100, blank=True, null=True)
    ...
    order_shipping_address_line2 = models.CharField(max_length=100, blank=True, null=True)
    ...
    sales_person = models.ForeignKey('Employee', on_delete=models.SET_NULL, blank=True, null=True, related_name='sales')
    ...
    product = models.ForeignKey('Product', on_delete=models.SET_NULL, blank=True, null=True, related_name='sales')
    product_name = models.CharField(max_length=100)
    product_quantity = models.PositiveIntegerField()
    product_price = models.DecimalField(max_digits=10, decimal_places=2)
    product_discount = models.DecimalField(max_digits=10, decimal_places=2, default=0)
    product_tax = models.DecimalField(max_digits=10, decimal_places=2, default=0)
    product_shipping_cost = models.DecimalField(max_digits=10, decimal_places=2, default=0)
    ...
    cancelation_status = models.CharField(max_length=50, blank=True, null=True)
    ...
    promotion_discount = models.DecimalField(max_digits=10, decimal_places=2, blank=True, null=True)
...
class Product(models.Model):
    ...
    storage_temperature = models.DecimalField(max_digits=5, decimal_places=2)
    storage_humidity = models.DecimalField(max_digits=5, decimal_places=2)
    ...
    product_ratings = models.DecimalField(max_digits=3, decimal_places=2, blank=True, null=True)
    ...
    product_lifecycle = models.CharField(max_length=50, blank=True, null=True)
    product_roadmap = models.TextField(blank=True, null=True)
    product_retirement_date = models.DateField(blank=True, null=True)
    product_successor = models.CharField(max_length=100, blank=True, null=True)
    product_notes = models.TextField(blank=True, null=True)
    supervising_employee = models.ForeignKey(Employee, on_delete=models.SET_NULL, blank=True, null=True, related_name='supervised_products')
    # product_sales = models.ForeignKey(Sale, on_delete=models.SET_NULL, blank=True, null=True, related_name='products')
    product_name = models.CharField(max_length=100)